...
/**
 Model used for the WrongTextAnswer TableView Cell in the FinishedGameViewController
 */
internal class WrongTextAnswerModel: UITableViewCell
{
    // - MARK: properties
    /// question text
    ...
    /// use response
    @IBOutlet weak var userResponse: UILabel!
    /// right answer
    ...
    internal func initCell(question: Question) {
        ...
        self.userResponse.text = question.userAnswer?.getReponseTextForId(id: question.userAnswer?.userReponseId)
