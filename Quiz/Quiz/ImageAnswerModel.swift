...
/**
 Model used for the ImageAnswer TableView Cell in the FinishedGameViewController
 */
internal class ImageAnswerModel: UITableViewCell
{
    // - MARK: properties
    /// question text
    ...
    /// use response
    @IBOutlet weak var userResponse: UIImageView!
    /// use answser
    @IBOutlet weak var response: UIImageView!
    /// time that took the user to respond
    @IBOutlet weak var time: UILabel!
    /// main view cell
    @IBOutlet weak var mainView: UIView!
    /// wrong cross on top of the user response
    @IBOutlet weak var wrongCross: UIImageView!
    // - MARK: Methods
    /**
    ...
    internal func initCell(question: Question) {
        ...
        {
            self.wrongCross.isHidden = false
        }
